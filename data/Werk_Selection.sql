...
WHERE w.JAHR = (
SELECT JAHR FROM ivis_fs16.Werk WHERE HAUPTNR = '9894840'
) LIMIT 20;
...
ON w.URHAUPTNR = p.HAUPTNR
WHERE w.URHAUPTNR = (
SELECT URHAUPTNR FROM ivis_fs16.Werk WHERE HAUPTNR = '9894840'
) LIMIT 20;
